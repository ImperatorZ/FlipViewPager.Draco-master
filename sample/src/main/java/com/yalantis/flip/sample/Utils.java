...
public class Utils {
    ...
    static {
        friends.add(new Friend(R.drawable.anastasia, "Выживший", R.color.sienna, "R.drawable.star", "Время; 220мин", "250руб", "Зал №2", "Соск"));
        friends.add(new Friend(R.drawable.irene, "1+1", R.color.saffron, "Travelling", "Flights", "Books", "Painting", "Design"));
